...
<body>
   ...
   <div class="navbar  m-2">
      ...
      <nav class="m-2">
         ...
         <button class="btn btn-primary" type="button" id="change">Edit</button>
   ...
   <div class="container d-flex">
      ...
      <div class="container-sm bg-dark" id="placeToLoad" style="display:none; width:50rem; border:solid 1px black; height:15rem; overflow:scroll;"></div>
   </div>
